package org.example.staticspecservice.constant;
...
public class SuccessMessage {
    ...
    public static class StaticSpec {
        public static final String IMPORT_CAR_SPEC_SUCCESS = "Car specification imported successfully";
        public static final String RESET_PARAMETERS_SUCCESS = "Static specification parameters reset to default values successfully";
    }
}

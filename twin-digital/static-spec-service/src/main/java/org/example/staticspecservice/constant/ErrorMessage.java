...
public class ErrorMessage {
  ...
  public static class StaticSpec {
    public static final String ERR_PARAMETER_NOT_FOUND = "exception.static.spec.parameter.not-found";
    public static final String ERR_IMPORT_CAR_SPEC_FAIL = "exception.static.spec.failed.import";
